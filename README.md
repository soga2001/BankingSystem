...
This is a Banking System made using **C++** with **Hashing Data Structure** as well as **Singly Linked List** for better and easier access to user information. Instead of 2 classes, I used one but my program is using two data structure.<br> 
...
To download my program, click the green "Code" button on my finalproject Github page.
